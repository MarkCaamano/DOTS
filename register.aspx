    ...
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" ID="Table1" style="margin: 0% 0% 0% 10%;">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtFirstName" runat="server" Width="173" Height="30"></asp:TextBox>&nbsp;
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtLastName" runat="server" Width="173" Height="30"></asp:TextBox>&nbsp;
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtBoxEmail" runat="server" Width="173" Height="30"></asp:TextBox>&nbsp;
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtPassword" runat="server" Width="173" Height="30" TextMode="Password"></asp:TextBox>&nbsp;
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtConfirmPassword" runat="server" Width="173" Height="30" TextMode="Password"></asp:TextBox>&nbsp;
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtCompany" runat="server" Width="173" Height="30" Enabled="False"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <%--            <asp:TableRow>
                <asp:TableCell>
