...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="idCourse" aria-busy="False">
        <div class="idCourseTitle">
            ...
            <div class="rightFloat">
                <asp:Button ID="btnNew" runat="server" Text="New" CssClass="btnSubmitPassword" OnClick="btnNew_Click" />
          ...
          <asp:Button ID="btnNewer" runat="server" Text="Click Me!" Visible="False"/>
    ...
    <ajaxPop:ModalPopupExtender ID="mUserPop" runat="server" PopupControlID="pNewUser" TargetControlID="btnNewer" BackgroundCssClass="modalBackground" BehaviorID="mUserPop1"  />
    <%--  --%>

    <asp:Panel ID="pNewUser" runat="server" CssClass="modalPopup" ValidateRequestMode="Inherit" Visible="False">
        <div class="modalHeader" style="height: 30px">
            New User
            <div class="rightFloat">
                Access
                <asp:DropDownList ID="ddlAccessLevel" runat="server" AppendDataBoundItems="True" Height="30">
        ...
        <asp:Table runat="server" ID="tblPassword" CssClass="tblPassword" CellPadding="5" Width="100%">
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <br />
                    <asp:TextBox ID="txtAddEmail" runat="server" Width="100%" Height="30"></asp:TextBox>
                    <br />
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <br />
                    <asp:TextBox ID="txtAddFirstName" runat="server" Width="100%" Height="30"></asp:TextBox>
                    <br />
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <br />
                    <asp:TextBox ID="txtAddLastName" runat="server" Width="100%" Height="30"></asp:TextBox>
                    <br />
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <br />
                    <asp:TextBox ID="lblCompanyText" runat="server" Width="100%" Height="30" BorderStyle="None" ReadOnly="True"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
        ...
        <div style="padding-left: 40px; width: 411px;">
            ...
            <asp:Label ID="lblError" runat="server" CssClass="warning" Visible="False"></asp:Label>
        </div>
        <br />
        <asp:Table runat="server" ID="Table2" CssClass="rightFloat" Style="margin-right: 14px; margin-bottom: 10px;">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:LinkButton ID="lnkSubmitUser" runat="server" CssClass="btnNewUser" Text="Add" OnClick="lnkSubmitUser_Click" ValidationGroup="NewUser"></asp:LinkButton>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:LinkButton ID="lnkCancel" runat="server" CssClass="btnCancel" Text="Cancel" OnClick="CancelUser_Click"></asp:LinkButton>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
